    ...
    public void run() {
        ...
        if (!isFinisheed) {
            ...
            CommandScheduler.getInstance().schedule(new SequentialCommandGroup(
                    new GotoConstantHeading(3, 0),
                    new GotoConstantHeading(3, 51),
            new GotoLinearHeading(2, 51, -45),

                    CommandGroups.TransferConeGroup(12, 47, -45, 1010),

                    new GotoLinearHeading(-3.6, 54, 0),
                    CommandGroups.CatchConeGroup(-354),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    new GotoConstantHeading(8, 51 ),
                    CommandGroups.TransferConeGroup(12, 47, -45, 1010),


                    new GotoLinearHeading(-3, 54, 0),
                    CommandGroups.CatchConeGroup(-382),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    new GotoConstantHeading(8, 51),
                    CommandGroups.TransferConeGroup(13.5, 47, -45, 1010),

                    new GotoLinearHeading(-1.8, 53,0),
                    CommandGroups.CatchConeGroup(-396),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    new GotoConstantHeading(8, 51),
                    CommandGroups.TransferConeGroup(13.5, 47, -45, 1010),
                    ...
                    new GotoLinearHeading(9.5, 52, 90),
