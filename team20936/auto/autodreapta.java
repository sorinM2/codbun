    ...
    public void run() {
        ...
        if (!isFinisheed) {
            ...
            new GotoConstantHeading(2, 52),
                    ...
                    new GotoLinearHeading(11.5, 46, -180),
                    CommandGroups.CatchConeGroup(-354),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    new GotoConstantHeading(0.5, 48),
                    new GotoLinearHeading(0.5, 48, -138),
                    CommandGroups.TransferConeGroup(-0.5, 45),

                    new GotoLinearHeading(11.2, 46, -180),
                    CommandGroups.CatchConeGroup(-388),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    new GotoConstantHeading(0.5, 48),
                    new GotoLinearHeading(0.5, 48, -138),
                    CommandGroups.TransferConeGroup(-0.5, 44),

                    new GotoLinearHeading(9.70, 46, -180),
                    CommandGroups.CatchConeGroup(-405),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    ...
                    new GotoLinearHeading(0, 44, -180),
